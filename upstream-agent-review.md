...
The scheduled drift job flagged this because it treated any marketplace HEAD movement as skill-creator drift. The intervening history is plugin bumps (Salesforce, Convex, JFrog, and similar), not harness changes.
...
Agent verification (full fetch of both SHAs):
